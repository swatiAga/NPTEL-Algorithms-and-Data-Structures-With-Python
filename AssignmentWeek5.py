...
the_input_match_list = []
for item in matches:
    the_input_match_list.append(item.split(":"))
BEST_OF_3='best_of_3'
BEST_OF_5='best_of_5'
...
the_players_details = {}
for item in the_input_match_list:
    ...
    if item[0] not in the_players_details.keys():
        the_players_details[item[0]]={NO_OF_BEST5_WON:0,NO_OF_BEST3_WON:0,NO_OF_SETS_WON:0,NO_OF_GAMES_WON:0,NO_OF_SETS_LOST:0,NO_OF_GAMES_LOST:0}
    if item[1] not in the_players_details.keys():
        the_players_details[item[1]]={NO_OF_BEST5_WON:0,NO_OF_BEST3_WON:0,NO_OF_SETS_WON:0,NO_OF_GAMES_WON:0,NO_OF_SETS_LOST:0,NO_OF_GAMES_LOST:0}
    sets = item[2].split(',')
    type_of_match=''
    ...
    the_players_details[item[0]][NO_OF_SETS_WON]+=sets_won_by_fisrt_player
    the_players_details[item[0]][NO_OF_GAMES_WON]+=games_won_by_fisrt_player
    the_players_details[item[0]][NO_OF_SETS_LOST]+=sets_lost_by_fisrt_player
    the_players_details[item[0]][NO_OF_GAMES_LOST]+=games_lost_by_fisrt_player
    if(type_of_match==BEST_OF_5):
        the_players_details[item[0]][NO_OF_BEST5_WON]+=1
    else:
        the_players_details[item[0]][NO_OF_BEST3_WON]+=1
    
    the_players_details[item[1]][NO_OF_SETS_WON]+=sets_won_by_second_player
    the_players_details[item[1]][NO_OF_GAMES_WON]+=games_won_by_second_player
    the_players_details[item[1]][NO_OF_SETS_LOST]+=sets_lost_by_second_player
    the_players_details[item[1]][NO_OF_GAMES_LOST]+=games_lost_by_second_player
